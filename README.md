...
1.  **Clone đồ án:**
    ```bash
    git clone [https://github.com/Kyoyooo/HR-Analytics-Job-Change-of-Data-Scientists-Prediction.git](https://github.com/username/HR-Analytics-Job-Change-of-Data-Scientists-Prediction.git)
